...
var darkColors = __assign(__assign(__assign({}, baseColors), additionalColors), { secondary: "#9A6AFF", background: "#08060B", backgroundDisabled: "#3c3742", 
    ...
    backgroundAlt: "#FF5565", cardBorder: "#383241", contrast: "#FFFFFF", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#e8b5d0", inputSecondary: "#262130", primaryDark: "#0098A1", tertiary: "#e8b5d0", text: "#332f3a", textDisabled: "#666171", textSubtle: "#ffffff", borderColor: "#524B63", gradients: {
...
var Logo$2 = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 64 64" }, props),
        React__default['default'].createElement("image", { width: "64", height: "64", href: '/images/logo.png' })));
};
